...
// unknown is a top type that says: give me any value, I will hide it and won't leak what you have given me
...
if (isDefined(Osama)) {
  console.log(Osama.email, Osama.name);
}
